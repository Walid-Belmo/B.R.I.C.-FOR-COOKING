...
// Moved to 19 and 16 to avoid conflict with Servos on 22, 23
...
void setup() {
  ...
  Serial.println("--- 5-DOF ARM + 2 MAGNET CONTROLLER ---");
  ...
  Serial.println("Servo Cmd: 's1-1500', 'set'");
  Serial.println("Magnet Cmd: 'm1-1' (ON), 'm1-0' (OFF), 'm2-1', 'm2-0'");
}
